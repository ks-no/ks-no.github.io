...
1. [Ta i bruk Fiks Protokoll](ta_ibruk_protokoll.md)
1. [Opprette system](opprette_system.md)
1. [Opprette konto](opprette_konto.mdo)
1. [Gi tilgang til system](gi_tilgang_til_system.md)
...
* [Generer nytt passord](nytt_passord.md)
* [Ny offentlig nøkkel](laste_opp_ny_offentlig_nokkel.md)
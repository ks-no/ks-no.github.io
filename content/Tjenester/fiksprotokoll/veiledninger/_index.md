...
Før du starter, kan det være lurt å gjøre seg kjent med den [konseptuelle modellen]({{% ref "konseptuell_modell.md" %}}) for Fiks Protokoll, slik at du vet hva de forskjellige begrepene betyr og innebærer. 

...
|------|------|
| Web portal | Nei |
| Maskin til maskin | [Api-spec](https://editor-next.swagger.io/?url=https://developers.fiks.ks.no/api/innreise-api-v1.json) |
...
## Integrasjon [(api-spec)](https://editor-next.swagger.io/?url=https://developers.fiks.ks.no/api/innreise-api-v1.json)

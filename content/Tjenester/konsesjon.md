...
### API
Vi har laget et førsteutkast av en API-spec. Denne ligger [her](https://editor.swagger.io/?url=https://developers.fiks.ks.no/api/konsesjon-megler-api-v1.json). Her vil det komme endringer som brekker kontrakten. Kontrakten låses ikke før vi er i produksjon.

...
{{% notice style="warning" title="Viktig informasjon" %}}
...
| /mottakersystem          | GET    | Optional query parameters: organisasjonsNummer, forsendelsesType, niva | List\<MottakerForsendelsesTyper\>                          | Henter alle mottakersystem. Kan filtreres på organisasjonsnummer, forsendelsestype og nivå. |

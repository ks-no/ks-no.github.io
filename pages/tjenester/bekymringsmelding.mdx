...
![Idporten](../felles/images/Bekymringsmelding_4.png "")
...
Før løsningen kan tas i bruk må kommunen inngå en avtale om bruk. Denne finnes [her](https://svarut.wordpress.com/fiks/avtalen/)
...
Informasjon om generell integrasjonsutvikling mot Fiks, som blant annet autentisering, finner man på [developer.fiks.ks.no](https://ks-no.github.io/fiks-plattform/integrasjoner/).
...
** Sekvensdiagram **
![Idporten](../felles/images/FagsystemSomProdusentv3.png "")
